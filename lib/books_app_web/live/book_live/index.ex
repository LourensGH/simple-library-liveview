defmodule BooksAppWeb.BookLive.Index do
  use BooksAppWeb, :live_view

  alias BooksApp.Library
  alias BooksApp.Library.Book
  ...
  @impl true
  def handle_info({BooksAppWeb.BookLive.FormComponent, {:saved, book}}, socket) do
